...
export const Auth = () => {
    ...
    return (
        <div className="flex justify-center items-center flex-center flex-col min-h-screen text-gray-600 font-mono">
            ...
            <form onSubmit= {submitAuthHandler}>
                <div>
                    <input
                        className="mb-3 px-3 text-sm py-2 bprder border-gray-300"
                        name="email"
                        type="email"
                        autoFocus
